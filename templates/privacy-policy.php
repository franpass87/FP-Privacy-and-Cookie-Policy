...
// Policy in inglese: titoli letterali EN (WPML/gettext può lasciare attivo it_IT sui msgid inglesi).
...
// Genera lista delle sezioni per il sommario (msgid in inglese nei .po per le altre lingue).
$fp_privacy_section_label_map = array(
	'overview'                 => 'Overview',
	'definitions'              => 'Definitions',
	'data-controller'          => 'Data controller',
	'applicable-laws'          => 'Applicable laws',
	'data-categories'          => 'Categories of personal data we process',
	'data-sources'             => 'Origin of personal data',
	'mandatory-optional'       => 'Mandatory and optional data',
	'processing-purposes'      => 'Purposes of processing',
	'legal-bases'              => 'Legal bases',
	'recipients'               => 'Recipients and international transfers',
	'processors'               => 'Processors and authorised staff',
	'security-measures'        => 'Security measures',
	'automated-decision'       => 'Automated decision-making and profiling',
	'ai-disclosure'            => 'AI and machine learning data processing',
	'algorithmic-transparency' => 'Algorithmic transparency',
	'retention'                => 'Retention',
	'data-subject-rights'      => 'Data subject rights',
	'exercise-rights'          => 'How to exercise your rights',
	'consent-withdrawal'       => 'Withdrawal of consent and cookie management',
	'minors-data'              => 'Children\'s personal data',
	'data-breach'              => 'Personal data breach handling',
	'dpo'                      => 'Data Protection Officer',
	'supervisory-authority'    => 'Contacting the supervisory authority',
	'governance'               => 'Governance and updates to this privacy notice',
	'services-cookies'         => 'Services and cookies',
...
<nav class="fp-privacy-toc" aria-label="<?php echo esc_attr( fp_privacy_policy_msg( 'Table of contents', $fp_policy_is_en ) ); ?>">
    <h2><?php echo esc_html( fp_privacy_policy_msg( 'Table of contents', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-overview"><?php echo esc_html( fp_privacy_policy_msg( 'Overview', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-definitions"><?php echo esc_html( fp_privacy_policy_msg( 'Definitions', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-data-controller"><?php echo esc_html( fp_privacy_policy_msg( 'Data controller', $fp_policy_is_en ) ); ?></h2>
<p>
...
<h2 id="fp-privacy-applicable-laws"><?php echo esc_html( fp_privacy_policy_msg( 'Applicable laws', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-data-categories"><?php echo esc_html( fp_privacy_policy_msg( 'Categories of personal data we process', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-data-sources"><?php echo esc_html( fp_privacy_policy_msg( 'Origin of personal data', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-mandatory-optional"><?php echo esc_html( fp_privacy_policy_msg( 'Mandatory and optional data', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-processing-purposes"><?php echo esc_html( fp_privacy_policy_msg( 'Purposes of processing', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-legal-bases"><?php echo esc_html( fp_privacy_policy_msg( 'Legal bases', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-recipients"><?php echo esc_html( fp_privacy_policy_msg( 'Recipients and international transfers', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-processors"><?php echo esc_html( fp_privacy_policy_msg( 'Processors and authorised staff', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-security-measures"><?php echo esc_html( fp_privacy_policy_msg( 'Security measures', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-automated-decision"><?php echo esc_html( fp_privacy_policy_msg( 'Automated decision-making and profiling', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-retention"><?php echo esc_html( fp_privacy_policy_msg( 'Retention', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-data-subject-rights"><?php echo esc_html( fp_privacy_policy_msg( 'Data subject rights', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-exercise-rights"><?php echo esc_html( fp_privacy_policy_msg( 'How to exercise your rights', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-consent-withdrawal"><?php echo esc_html( fp_privacy_policy_msg( 'Withdrawal of consent and cookie management', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-minors-data"><?php echo esc_html( fp_privacy_policy_msg( 'Children\'s personal data', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-data-breach"><?php echo esc_html( fp_privacy_policy_msg( 'Personal data breach handling', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-dpo"><?php echo esc_html( fp_privacy_policy_msg( 'Data Protection Officer', $fp_policy_is_en ) ); ?></h2>
<p><?php echo esc_html( $dpo_name ); ?> — <?php echo esc_html( $dpo_mail ); ?></p>
<?php endif; ?>

<h2 id="fp-privacy-supervisory-authority"><?php echo esc_html( fp_privacy_policy_msg( 'Contacting the supervisory authority', $fp_policy_is_en ) ); ?></h2>
...
<h2 id="fp-privacy-governance"><?php echo esc_html( fp_privacy_policy_msg( 'Governance and updates to this privacy notice', $fp_policy_is_en ) ); ?></h2>
...
<th><?php echo esc_html( fp_privacy_policy_msg( 'Provider', $fp_policy_is_en ) ); ?></th>
<th><?php echo esc_html( fp_privacy_policy_msg( 'Purpose', $fp_policy_is_en ) ); ?></th>
<th><?php echo esc_html( fp_privacy_policy_msg( 'Cookies & Retention', $fp_policy_is_en ) ); ?></th>
<th><?php echo esc_html( fp_privacy_policy_msg( 'Legal basis', $fp_policy_is_en ) ); ?></th>
</tr>
</thead>
<tbody>
...
<td>
    ...
    <?php if ( '' !== $policy_url ) : ?> — <a href="<?php echo esc_url( $policy_url ); ?>" target="_blank" rel="noopener noreferrer"><?php echo esc_html( fp_privacy_policy_msg( 'Privacy Policy', $fp_policy_is_en ) ); ?></a><?php endif; ?>
</td>
...
<h2 id="fp-privacy-last-update"><?php echo esc_html( fp_privacy_policy_msg( 'Last updated', $fp_policy_is_en ) ); ?></h2>
<p><?php echo esc_html( sprintf( fp_privacy_policy_msg( 'This privacy policy was generated on %s.', $fp_policy_is_en ), $last_generated ) ); ?></p>
</section>
