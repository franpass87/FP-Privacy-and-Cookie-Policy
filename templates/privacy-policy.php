...
// Msgid in inglese: in assenza di .mo (cache/WPML) il fallback resta EN, non IT.
$sections = array(
	'overview'                 => esc_html__( 'Overview', 'fp-privacy' ),
	'definitions'              => esc_html__( 'Definitions', 'fp-privacy' ),
	'data-controller'          => esc_html__( 'Data controller', 'fp-privacy' ),
	'applicable-laws'          => esc_html__( 'Applicable laws', 'fp-privacy' ),
	'data-categories'          => esc_html__( 'Categories of personal data we process', 'fp-privacy' ),
	'data-sources'             => esc_html__( 'Origin of personal data', 'fp-privacy' ),
	'mandatory-optional'       => esc_html__( 'Mandatory and optional data', 'fp-privacy' ),
	'processing-purposes'      => esc_html__( 'Purposes of processing', 'fp-privacy' ),
	'legal-bases'              => esc_html__( 'Legal bases', 'fp-privacy' ),
	'recipients'               => esc_html__( 'Recipients and international transfers', 'fp-privacy' ),
	'processors'               => esc_html__( 'Processors and authorised staff', 'fp-privacy' ),
	'security-measures'        => esc_html__( 'Security measures', 'fp-privacy' ),
	'automated-decision'       => esc_html__( 'Automated decision-making and profiling', 'fp-privacy' ),
	'ai-disclosure'            => esc_html__( 'AI and machine learning data processing', 'fp-privacy' ),
	'algorithmic-transparency' => esc_html__( 'Algorithmic transparency', 'fp-privacy' ),
	'retention'                => esc_html__( 'Retention', 'fp-privacy' ),
	'data-subject-rights'      => esc_html__( 'Data subject rights', 'fp-privacy' ),
	'exercise-rights'          => esc_html__( 'How to exercise your rights', 'fp-privacy' ),
	'consent-withdrawal'       => esc_html__( 'Withdrawal of consent and cookie management', 'fp-privacy' ),
	'minors-data'              => esc_html__( 'Children\'s personal data', 'fp-privacy' ),
	'data-breach'              => esc_html__( 'Personal data breach handling', 'fp-privacy' ),
	'dpo'                      => esc_html__( 'Data Protection Officer', 'fp-privacy' ),
	'supervisory-authority'    => esc_html__( 'Contacting the supervisory authority', 'fp-privacy' ),
	'governance'               => esc_html__( 'Governance and updates to this privacy notice', 'fp-privacy' ),
	'services-cookies'         => esc_html__( 'Services and cookies', 'fp-privacy' ),
	'last-update'              => esc_html__( 'Last updated', 'fp-privacy' ),
);
?>
...
<h2 id="fp-privacy-overview"><?php echo esc_html__( 'Overview', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-definitions"><?php echo esc_html__( 'Definitions', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-data-controller"><?php echo esc_html__( 'Data controller', 'fp-privacy' ); ?></h2>
<p>
...
<h2 id="fp-privacy-applicable-laws"><?php echo esc_html__( 'Applicable laws', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-data-categories"><?php echo esc_html__( 'Categories of personal data we process', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-data-sources"><?php echo esc_html__( 'Origin of personal data', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-mandatory-optional"><?php echo esc_html__( 'Mandatory and optional data', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-legal-bases"><?php echo esc_html__( 'Legal bases', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-recipients"><?php echo esc_html__( 'Recipients and international transfers', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-processors"><?php echo esc_html__( 'Processors and authorised staff', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-security-measures"><?php echo esc_html__( 'Security measures', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-automated-decision"><?php echo esc_html__( 'Automated decision-making and profiling', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-retention"><?php echo esc_html__( 'Retention', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-data-subject-rights"><?php echo esc_html__( 'Data subject rights', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-exercise-rights"><?php echo esc_html__( 'How to exercise your rights', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-consent-withdrawal"><?php echo esc_html__( 'Withdrawal of consent and cookie management', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-minors-data"><?php echo esc_html__( 'Children\'s personal data', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-data-breach"><?php echo esc_html__( 'Personal data breach handling', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-dpo"><?php echo esc_html__( 'Data Protection Officer', 'fp-privacy' ); ?></h2>
<p><?php echo esc_html( $dpo_name ); ?> — <?php echo esc_html( $dpo_mail ); ?></p>
<?php endif; ?>

<h2 id="fp-privacy-supervisory-authority"><?php echo esc_html__( 'Contacting the supervisory authority', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-governance"><?php echo esc_html__( 'Governance and updates to this privacy notice', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-services-cookies"><?php echo esc_html__( 'Services and cookies', 'fp-privacy' ); ?></h2>
...
<h2 id="fp-privacy-last-update"><?php esc_html_e( 'Last updated', 'fp-privacy' ); ?></h2>
