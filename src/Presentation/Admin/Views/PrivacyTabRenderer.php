...
class PrivacyTabRenderer extends SettingsRendererBase {
	...
	public function render( array $data ) {
		...
		<div class="fp-privacy-tab-content" id="fp-privacy-tab-content-privacy" role="tabpanel" aria-labelledby="fp-privacy-tab-button-privacy" data-tab-content="privacy">
			<?php
			$this->render_settings_section_open( 'dashicons-chart-bar', \__( 'Consent Mode — valori predefiniti', 'fp-privacy' ) );
			?>
			...
			<?php
			$this->render_settings_section_open( 'dashicons-privacy', \__( 'Global Privacy Control (GPC)', 'fp-privacy' ) );
			?>
			...
			<?php
			$this->render_settings_section_open( 'dashicons-backup', \__( 'Conservazione e revisione', 'fp-privacy' ) );
			?>
			...
			<?php
			$this->render_settings_section_open( 'dashicons-businessman', \__( 'Titolare e DPO', 'fp-privacy' ) );
			?>
			...
			<?php
			$this->render_settings_section_open( 'dashicons-media-code', \__( 'Trasparenza algoritmica (Digital Omnibus)', 'fp-privacy' ) );
			?>
