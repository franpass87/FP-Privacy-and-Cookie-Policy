...
class Commands extends WP_CLI_Command {
	 ...
	 *
	 * @var \FP\Privacy\Presentation\CLI\Commands\ConsentCommands
	 */
	 ...
	 *
	 * @var \FP\Privacy\Presentation\CLI\Commands\SettingsCommands
	 */
	 ...
	 *
	 * @var \FP\Privacy\Presentation\CLI\Commands\PolicyCommands
	 */
	...
	public function __construct( LogModel $log_model, Options $options, PolicyGenerator $generator, DetectorRegistry $detector, Cleanup $cleanup ) {
		$this->consent_commands  = new \FP\Privacy\Presentation\CLI\Commands\ConsentCommands( $log_model, $cleanup );
		$this->settings_commands = new \FP\Privacy\Presentation\CLI\Commands\SettingsCommands( $options );
		$this->policy_commands   = new \FP\Privacy\Presentation\CLI\Commands\PolicyCommands( $options, $generator, $detector );
	}
