...
class SettingsSaveHandler {
	...
	public function prepare_payload() {
		...
		$payload = array(
			...
			'dpo_name'               => isset( $_POST['dpo_name'] ) ? \sanitize_text_field( \wp_unslash( $_POST['dpo_name'] ) ) : '',
			'dpo_email'              => isset( $_POST['dpo_email'] ) ? \sanitize_email( \wp_unslash( $_POST['dpo_email'] ) ) : '',
			'privacy_email'          => isset( $_POST['privacy_email'] ) ? \sanitize_email( \wp_unslash( $_POST['privacy_email'] ) ) : '',
