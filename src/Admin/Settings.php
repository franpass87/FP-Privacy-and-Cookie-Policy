	...
	public function enqueue_assets( $hook ) {
		...
		\wp_localize_script(
			...
			array(
				...
				'expandAllSections'   => \__( 'Expand all sections', 'fp-privacy' ),
				'collapseAllSections' => \__( 'Collapse all sections', 'fp-privacy' ),
				'detectedSearchPlaceholder' => \__( 'Search service…', 'fp-privacy' ),
				'detectedCategoryAll' => \__( 'All categories', 'fp-privacy' ),
				'detectedStatusAll'   => \__( 'All statuses', 'fp-privacy' ),
				'categoryMarketing'   => \__( 'Marketing', 'fp-privacy' ),
				'categoryAnalytics'   => \__( 'Analytics', 'fp-privacy' ),
				'categoryNecessary'   => \__( 'Necessary', 'fp-privacy' ),
				'categoryPreferences' => \__( 'Preferences', 'fp-privacy' ),
				'statusDetected'      => \__( 'Detected', 'fp-privacy' ),
				'statusNotDetected'   => \__( 'Not detected', 'fp-privacy' ),
