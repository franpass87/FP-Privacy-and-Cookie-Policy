...
- Traduzioni italiane e inglesi del banner e delle categorie con rilevamento automatico della lingua del browser.
...
3. Configura il banner cookie (titolo, messaggio, etichette pulsanti) e decidi se mostrare il pulsante di rifiuto e quello delle preferenze.
   - Per ogni campo è disponibile la doppia versione italiano/inglese; il plugin sceglie automaticamente la lingua del browser dell'utente.
